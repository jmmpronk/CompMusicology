...
CountryEnergy <- ggplot(corpus, aes(x = valence, y = energy, fill = country, color = country, text = track.name)) + geom_point(alpha = 0.6, shape = 21, stroke = 1) + theme_tufte() + xlim(0, 1) + ylim(0, 1) + geom_smooth()
